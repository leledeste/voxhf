...
The root [README](../README.md) is the installation and usage guide. The files
...
- [Threat Model](THREAT_MODEL.md): trust boundaries and remote risks.
- [Security Audit](SECURITY_AUDIT.md): verified controls and residual risks.
- [Administration Redesign](ADMIN_REDESIGN.md): owner authentication, sessions,
  optional passkey MFA, recovery, and the admin information architecture.
- [Admin MFA Validation](MFA_TESTING.md): HTTPS preflight and real passkey test
  matrix for Windows, macOS, and iOS.
- [Dependency Policy](DEPENDENCY_POLICY.md): accepted licenses and review rules.
- [Third-Party Notices](THIRD_PARTY_NOTICES.md): runtime libraries and ffmpeg.
- [Security Policy](../SECURITY.md): vulnerability reporting and secure defaults.
