...
agent. Install the app on one supported phone or tablet, enable notifications
from Settings, and verify a real incoming private message while the screen is
locked.
